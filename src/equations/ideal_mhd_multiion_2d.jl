...
Here we assume v_e = v⁺ (no effect of currents on the electron velocity)
"""
function source_terms_collision_ion_electron_ohm(u, x, t, equations::IdealMhdMultiIonEquations2D)        
...
@inline function charge_averaged_velocities(u, equations::IdealMhdMultiIonEquations2D)
  ...
  for k in eachcomponent(equations)
    rho, rho_v1, rho_v2, rho_v3, _ = get_component(k, u, equations::IdealMhdMultiIonEquations2D)
