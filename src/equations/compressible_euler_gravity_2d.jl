...
@muladd begin
    ...
    varnames(::typeof(cons2cons), ::CompressibleEulerEquationsWithGravity2D) = ("rho",
                                                                                ...
                                                                                "rho_e",
                                                                                "phi")
    varnames(::typeof(cons2prim), ::CompressibleEulerEquationsWithGravity2D) = ("rho", "v1",
                                                                                "v2", "p",
                                                                                "phi")
    ...
    function flux_hllc(u_ll, u_rr, orientation::Integer,
        ...
        rho_ll, rho_v1_ll, rho_v2_ll, rho_e_ll, _ = u_ll
        rho_rr, rho_v1_rr, rho_v2_rr, rho_e_rr, _ = u_rr
    ...
    @inline function max_abs_speeds(u, equations::CompressibleEulerEquationsWithGravity2D)
        rho, v1, v2, p, _ = cons2prim(u, equations)
    ...
    @inline function cons2entropy(u, equations::CompressibleEulerEquationsWithGravity2D)
        rho, rho_v1, rho_v2, rho_e, phi = u
    ...
    @inline function entropy2cons(w, equations::CompressibleEulerEquationsWithGravity2D)
    ...
    @inline function prim2cons(prim, equations::CompressibleEulerEquationsWithGravity2D)
    ...
    @inline function density_pressure(u, equations::CompressibleEulerEquationsWithGravity2D)
        rho, rho_v1, rho_v2, rho_e, phi = u
        rho_times_p = (equations.gamma - 1) *
                      (rho * rho_e - 0.5 * (rho_v1^2 + rho_v2^2) - rho * phi)
        return rho_times_p
    end
    ...
    @inline function entropy_math(cons, equations::CompressibleEulerEquationsWithGravity2D)
    ...
    @inline function energy_kinetic(u, equations::CompressibleEulerEquationsWithGravity2D)
        rho, rho_v1, rho_v2, rho_e, _ = u
